...
add_action( 'wp_enqueue_scripts', 'alpha_omega_digital_custom_gutenberg_css' );
/**
 * Outputs front-end inline styles based on colors declared in config/appearance.php.
 *
 * @since 2.9.0
 */
function alpha_omega_digital_custom_gutenberg_css() {
...
CSS;
	...
	$css .= alpha_omega_digital_inline_font_sizes();
	$css .= alpha_omega_digital_inline_color_palette();

	wp_add_inline_style( genesis_get_theme_handle() . '-gutenberg', $css );

}

add_action( 'enqueue_block_editor_assets', 'alpha_omega_digital_custom_gutenberg_admin_css' );
/**
 ...
 * @since 2.9.0
 */
function alpha_omega_digital_custom_gutenberg_admin_css() {
...
CSS;
	...
	$css .= alpha_omega_digital_editor_inline_color_palette();
 ...
 */
function alpha_omega_digital_inline_font_sizes() {
 ...
 */
function alpha_omega_digital_inline_color_palette() {
 ...
 * @return string The editor colors CSS if `editor-color-palette` theme support was declared.
 */
function alpha_omega_digital_editor_inline_color_palette() {
