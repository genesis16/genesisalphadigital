...
add_action( 'wp_enqueue_scripts', 'alpha_omega_digital_enqueue_gutenberg_frontend_styles' );
/**
 * Enqueues Gutenberg front-end styles.
 *
 * @since 2.7.0
 */
function alpha_omega_digital_enqueue_gutenberg_frontend_styles() {
...
add_action( 'enqueue_block_editor_assets', 'alpha_omega_digital_block_editor_styles' );
/**
 * Enqueues Gutenberg admin editor fonts and styles.
 *
 * @since 2.7.0
 */
function alpha_omega_digital_block_editor_styles() {
...
add_filter( 'body_class', 'alpha_omega_digital_blocks_body_classes' );
/**
 ...
 */
function alpha_omega_digital_blocks_body_classes( $classes ) {
...
$alpha_omega_digital_appearance = genesis_get_config( 'appearance' );

// Adds support for editor font sizes.
add_theme_support(
	'editor-font-sizes',
	$alpha_omega_digital_appearance['editor-font-sizes']
);

// Adds support for editor color palette.
add_theme_support(
	'editor-color-palette',
	$alpha_omega_digital_appearance['editor-color-palette']
);

require_once get_stylesheet_directory() . '/lib/gutenberg/inline-styles.php';

add_action( 'after_setup_theme', 'alpha_omega_digital_content_width', 0 );
/**
 * Set content width to match the “wide” Gutenberg block width.
 */
function alpha_omega_digital_content_width() {

	$appearance = genesis_get_config( 'appearance' );

	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound -- See https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/924
	$GLOBALS['content_width'] = apply_filters( 'alpha_omega_digital_content_width', $appearance['content-width'] );
