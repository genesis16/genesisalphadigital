...
add_filter( 'woocommerce_style_smallscreen_breakpoint', 'alpha_omega_digital_woocommerce_breakpoint' );
/**
 ...
 */
function alpha_omega_digital_woocommerce_breakpoint() {
...
add_filter( 'genesiswooc_products_per_page', 'alpha_omega_digital_default_products_per_page' );
/**
 ...
 */
function alpha_omega_digital_default_products_per_page() {

	return 8;

}

add_filter( 'woocommerce_pagination_args', 'alpha_omega_digital_woocommerce_pagination' );
/**
 ...
 */
function alpha_omega_digital_woocommerce_pagination( $args ) {

	$args['prev_text'] = sprintf( '&laquo; %s', __( 'Previous Page', 'alpha-omega-digital' ) );
	$args['next_text'] = sprintf( '%s &raquo;', __( 'Next Page', 'alpha-omega-digital' ) );

	return $args;

}

add_action( 'after_switch_theme', 'alpha_omega_digital_woocommerce_image_dimensions_after_theme_setup', 1 );
/**
 * Defines WooCommerce image sizes on theme activation.
 *
 * @since 2.3.0
 */
function alpha_omega_digital_woocommerce_image_dimensions_after_theme_setup() {
	...
	alpha_omega_digital_update_woocommerce_image_dimensions();

}

add_action( 'activated_plugin', 'alpha_omega_digital_woocommerce_image_dimensions_after_woo_activation', 10, 2 );
/**
 ...
 */
function alpha_omega_digital_woocommerce_image_dimensions_after_woo_activation( $plugin ) {
 ...
 * @since 2.3.0
 */
function alpha_omega_digital_update_woocommerce_image_dimensions() {
...
add_filter( 'woocommerce_get_image_size_gallery_thumbnail', 'alpha_omega_digital_gallery_image_thumbnail' );
/**
 ...
 */
function alpha_omega_digital_gallery_image_thumbnail( $size ) {
