...
add_filter( 'woocommerce_enqueue_styles', 'alpha_omega_digital_woocommerce_styles' );
/**
 ...
 */
function alpha_omega_digital_woocommerce_styles( $enqueue_styles ) {
...
add_action( 'wp_enqueue_scripts', 'alpha_omega_digital_woocommerce_css' );
/**
 ...
 */
function alpha_omega_digital_woocommerce_css() {
	...
	$color_link   = get_theme_mod( 'alpha_omega_digital_link_color', $appearance['default-colors']['link'] );
	$color_accent = get_theme_mod( 'alpha_omega_digital_accent_color', $appearance['default-colors']['accent'] );
	...
	',
		$color_accent,
		alpha_omega_digital_color_contrast( $color_accent )
	) : '';
