...
$alpha_omega_digital_shared_content = genesis_get_config( 'onboarding-shared' );

return [
	'starter_packs' => [
		'black-white' => [
			'title'       => __( 'Black & White', 'alpha-omega-digital' ),
			'description' => __( 'A pack with a homepage designed with black and white images.', 'alpha-omega-digital' ),
			...
			'config'      => [
				'dependencies'     => [
					'plugins' => $alpha_omega_digital_shared_content['plugins'],
				],
				'content'          => array_merge(
					[
						'homepage' => [
					...
					$alpha_omega_digital_shared_content['content']
				),
				'navigation_menus' => $alpha_omega_digital_shared_content['navigation_menus'],
				'widgets'          => $alpha_omega_digital_shared_content['widgets'],
			],
		],
		'color'       => [
			'title'       => __( 'Color', 'alpha-omega-digital' ),
			'description' => __( 'A pack with a homepage designed with color images.', 'alpha-omega-digital' ),
