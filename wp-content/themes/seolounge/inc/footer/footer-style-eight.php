<?php
/**
 * Template for Footer Style Eight
 *
 * @package seolounge
 */
...
<footer class="wraper_footer style-eight">
	...
	for ( $j = 1; $j <= 4; $j++ ) {
		if ( is_active_sidebar( 'seolounge-footer-area-' . $j ) ) {
			...
			<div class="row footer_main">
				...
				for ( $j = 1; $j <= 4; $j++ ) {
					if ( is_active_sidebar( 'seolounge-footer-area-' . $j ) ) {
						...
						dynamic_sidebar( 'seolounge-footer-area-' . $j );
						echo '</div></div>';
					}
				}
				?>
			...
			<div class="row footer_copyright">
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					...
					<div class="footer_copyright_item text-left">
						...
						?>
						<?php if ( seolounge_global_var( 'footer_eight_contact_address', '', false ) ) : ?>
						    <p><?php echo esc_html__( 'Address: ', 'seolounge' ); ?><br><?php echo esc_html( seolounge_global_var( 'footer_eight_contact_address', '', false ) ); ?></p>
						<?php endif; ?>
						<p class="copyright"><?php echo wp_kses_post( seolounge_global_var( 'footer_eight_copyright_text', '', false ) ); ?></p>
					</div>
					<!-- footer_copyright_item -->
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					...
					<div class="footer_copyright_item text-right">
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( seolounge_global_var( 'footer_eight_copyright_logo', 'url', true ) ); ?>" alt="<?php echo esc_url( seolounge_global_var( 'footer_eight_copyright_logo', 'alt', true ) ); ?>"></a>
						<p><?php echo esc_html__( 'Connect with us', 'seolounge' ); ?></p>
						<?php
