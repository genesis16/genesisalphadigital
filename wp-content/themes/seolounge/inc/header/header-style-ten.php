...
<!-- wraper_header -->
<?php if ( true == seolounge_global_var( 'header_ten_floating', '', false ) ) { ?>
...
<?php } ?>
			...
			<div class="row header_top">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-left">
					...
					<div class="header_top_item">
						<?php if ( seolounge_global_var( 'header_ten_logo', 'url', true ) ) { ?>
		    				<!-- brand-logo -->
		    				<div class="brand-logo">
		    				    <div class="brand-logo-table">
            				        <div class="brand-logo-table-cell">
            				            <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( seolounge_global_var( 'header_ten_logo', 'url', true ) ); ?>" alt="<?php echo esc_attr( seolounge_global_var( 'header_ten_logo', 'alt', true ) ); ?>"></a>
            				        </div>
            				    </div>
		    				</div>
		    				<!-- brand-logo -->
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
					...
					<div class="header_top_item">
						<!-- contact -->
						<ul class="contact">
							<?php if ( ! empty( seolounge_global_var( 'header_ten_header_top_contact_phone', '', false ) ) ) : ?>
								<li class="phone"><?php echo wp_kses_post( seolounge_global_var( 'header_ten_header_top_contact_phone', '', false ) ); ?></li>
							<?php endif; ?>
							<?php if ( ! empty( seolounge_global_var( 'header_ten_header_top_contact_email', '', false ) ) ) : ?>
								<li class="email"><?php echo wp_kses_post( seolounge_global_var( 'header_ten_header_top_contact_email', '', false ) ); ?></li>
							<?php endif; ?>
						</ul>
						<!-- contact -->
	...
	<!-- wraper_header_main -->
	<!-- wraper_header_main -->
	<?php if ( true == seolounge_global_var( 'header_ten_sticky', '', false ) ) { ?>
	...
	<?php } ?>
		<div class="container">
			...
			<div class="header_main">
				<?php if ( true == seolounge_global_var( 'header_ten_mobile_menu_display', '', false ) ) : ?>
    				<!-- responsive-nav -->
				...
				<div class="header_main_action">
					<ul>
						...
						<?php endif; ?>
						<?php if ( true == seolounge_global_var( 'header_ten_search_display', '', false ) ) : ?>
							<?php if ( 'floating-search' == seolounge_global_var( 'header_ten_search_style', '', false ) ) { ?>
							...
							<?php } elseif ( 'flyout-search' == seolounge_global_var( 'header_ten_search_style', '', false ) ) { ?>
							...
							<?php } ?>
						<?php endif; ?>
						<?php if ( true == seolounge_global_var( 'header_ten_hamburger_display', '', false ) ) : ?>
							<?php if ( true == seolounge_global_var( 'header_ten_hamburger_mobile', '', false ) ) { ?>
                                <li class="header-hamburger">
                            <?php } else { ?>
                                <li class="header-hamburger hidden-sm hidden-xs">
                            <?php } ?>
								<?php if ( 'ellipsis' == seolounge_global_var( 'header_ten_hamburger_iconstyle', '', false ) ) { ?>
								    <i class="fa fa-ellipsis-v"></i>
								<?php } elseif ( 'three-bars' == seolounge_global_var( 'header_ten_hamburger_iconstyle', '', false ) ) { ?>
								    <i class="fa fa-bars"></i>
								<?php } elseif ( 'four-bars' == seolounge_global_var( 'header_ten_hamburger_iconstyle', '', false ) ) { ?>
								    <i class="fa fa-align-justify"></i>
								<?php } elseif ( 'four-bars-left' == seolounge_global_var( 'header_ten_hamburger_iconstyle', '', false ) ) { ?>
								    <i class="fa fa-align-left"></i>
								<?php } elseif ( 'four-bars-right' == seolounge_global_var( 'header_ten_hamburger_iconstyle', '', false ) ) { ?>
...
<?php if ( true == seolounge_global_var( 'header_ten_search_display', '', false ) ) : ?>
	<?php if ( 'flyout-search' == seolounge_global_var( 'header_ten_search_style', '', false ) ) : ?>
