 ...
 * Studio Pro Theme
 *
 * This file contains the RGBA color control class.
 *
 ...
 *
 * This control adds a second slider for opacity to the stock WordPress color
 * picker, and it includes logic to seamlessly convert between RGBa and
 * Hex color values as opacity is added to or removed from a color.
 */
