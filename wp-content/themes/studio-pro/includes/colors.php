 ...
 * Studio Pro Theme
 *
 * This file adds color settings to the child theme.
 *
...
class Studio_Pro_Color {
    ...
    */
	...
	/**
	 * Given a HEX value, returns a lighter color. If no desired amount provided, then
	 * the color halfway between given HEX and white will be returned.
	 *
	 ...
	 *
	 * @param int     $amount           Optional: percentage amount to light/darken the
	 *                                  gradient.
	 * @param boolean $vintage_browsers Optional: include vendor prefixes for browsers
	 *                                  that almost died out already.
