<?php
/**
 * alphaomegadigital genesis theme settings.
 *
...
return [
	GENESIS_SETTINGS_FIELD => [
		...
		'entry_meta_before_content' => '[post_date] ' . __( 'by', 'alphaomegadigital-genesis' ) . ' [post_author_posts_link] [post_comments] [post_edit]',
