...
add_action( 'wp_enqueue_scripts', 'alphaomegadigital_genesis_enqueue_gutenberg_frontend_styles' );
/**
 * Enqueues Gutenberg front-end styles.
 *
 * @since 2.7.0
 */
function alphaomegadigital_genesis_enqueue_gutenberg_frontend_styles() {
...
add_action( 'enqueue_block_editor_assets', 'alphaomegadigital_genesis_block_editor_styles' );
/**
 * Enqueues Gutenberg admin editor fonts and styles.
 *
 * @since 2.7.0
 */
function alphaomegadigital_genesis_block_editor_styles() {
...
add_filter( 'body_class', 'alphaomegadigital_genesis_blocks_body_classes' );
/**
 ...
 */
function alphaomegadigital_genesis_blocks_body_classes( $classes ) {
...
$alphaomegadigital_genesis_appearance = genesis_get_config( 'appearance' );

// Adds support for editor font sizes.
add_theme_support(
	'editor-font-sizes',
	$alphaomegadigital_genesis_appearance['editor-font-sizes']
);

// Adds support for editor color palette.
add_theme_support(
	'editor-color-palette',
	$alphaomegadigital_genesis_appearance['editor-color-palette']
);

require_once get_stylesheet_directory() . '/lib/gutenberg/inline-styles.php';

add_action( 'after_setup_theme', 'alphaomegadigital_genesis_content_width', 0 );
/**
 * Set content width to match the “wide” Gutenberg block width.
 */
function alphaomegadigital_genesis_content_width() {

	$appearance = genesis_get_config( 'appearance' );

	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound -- See https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/924
	$GLOBALS['content_width'] = apply_filters( 'alphaomegadigital_genesis_content_width', $appearance['content-width'] );
