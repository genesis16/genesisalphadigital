...
add_action( 'wp_enqueue_scripts', 'alphaomegadigital_genesis_css' );
/**
 ...
 * @since 2.2.3
 */
function alphaomegadigital_genesis_css() {
	...
	if ( $logo ) {
		...
		$logo_max_width        = get_theme_mod( 'alphaomegadigital_genesis_logo_width', 350 );
