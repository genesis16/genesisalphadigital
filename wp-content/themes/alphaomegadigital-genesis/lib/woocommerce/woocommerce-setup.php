...
add_filter( 'woocommerce_style_smallscreen_breakpoint', 'alphaomegadigital_genesis_woocommerce_breakpoint' );
/**
 ...
 */
function alphaomegadigital_genesis_woocommerce_breakpoint() {
...
add_filter( 'genesiswooc_products_per_page', 'alphaomegadigital_genesis_default_products_per_page' );
/**
 ...
 */
function alphaomegadigital_genesis_default_products_per_page() {

	return 8;

}

add_filter( 'woocommerce_pagination_args', 'alphaomegadigital_genesis_woocommerce_pagination' );
/**
 ...
 */
function alphaomegadigital_genesis_woocommerce_pagination( $args ) {

	$args['prev_text'] = sprintf( '&laquo; %s', __( 'Previous Page', 'alphaomegadigital-genesis' ) );
	$args['next_text'] = sprintf( '%s &raquo;', __( 'Next Page', 'alphaomegadigital-genesis' ) );

	return $args;

}

add_action( 'after_switch_theme', 'alphaomegadigital_genesis_woocommerce_image_dimensions_after_theme_setup', 1 );
/**
 * Defines WooCommerce image sizes on theme activation.
 *
 * @since 2.3.0
 */
function alphaomegadigital_genesis_woocommerce_image_dimensions_after_theme_setup() {
	...
	alphaomegadigital_genesis_update_woocommerce_image_dimensions();

}

add_action( 'activated_plugin', 'alphaomegadigital_genesis_woocommerce_image_dimensions_after_woo_activation', 10, 2 );
/**
 ...
 */
function alphaomegadigital_genesis_woocommerce_image_dimensions_after_woo_activation( $plugin ) {
 ...
 * @since 2.3.0
 */
function alphaomegadigital_genesis_update_woocommerce_image_dimensions() {
...
add_filter( 'woocommerce_get_image_size_gallery_thumbnail', 'alphaomegadigital_genesis_gallery_image_thumbnail' );
/**
 ...
 */
function alphaomegadigital_genesis_gallery_image_thumbnail( $size ) {
