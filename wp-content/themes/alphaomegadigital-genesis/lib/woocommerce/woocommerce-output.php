...
add_filter( 'woocommerce_enqueue_styles', 'alphaomegadigital_genesis_woocommerce_styles' );
/**
 ...
 */
function alphaomegadigital_genesis_woocommerce_styles( $enqueue_styles ) {
...
add_action( 'wp_enqueue_scripts', 'alphaomegadigital_genesis_woocommerce_css' );
/**
 ...
 */
function alphaomegadigital_genesis_woocommerce_css() {
	...
	$color_link   = get_theme_mod( 'alphaomegadigital_genesis_link_color', $appearance['default-colors']['link'] );
	$color_accent = get_theme_mod( 'alphaomegadigital_genesis_accent_color', $appearance['default-colors']['accent'] );
	...
	',
		$color_accent,
		alphaomegadigital_genesis_color_contrast( $color_accent )
	) : '';
