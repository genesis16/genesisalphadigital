...
add_filter( 'simple_social_default_styles', 'alphaomegadigital_genesis_social_default_styles' );
/**
 ...
 */
function alphaomegadigital_genesis_social_default_styles( $defaults ) {
