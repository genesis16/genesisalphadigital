...
add_action( 'after_setup_theme', 'alphaomegadigital_genesis_localization_setup' );
/**
 * Sets localization (do not remove).
 *
 * @since 1.0.0
 */
function alphaomegadigital_genesis_localization_setup() {
...
add_action( 'wp_enqueue_scripts', 'alphaomegadigital_genesis_enqueue_scripts_styles' );
/**
 * Enqueues scripts and styles.
 *
 * @since 1.0.0
 */
function alphaomegadigital_genesis_enqueue_scripts_styles() {
...
add_action( 'after_setup_theme', 'alphaomegadigital_genesis_theme_support', 9 );
/**
 ...
 * @since 3.0.0
 */
function alphaomegadigital_genesis_theme_support() {
...
add_action( 'after_setup_theme', 'alphaomegadigital_genesis_post_type_support', 9 );
/**
 ...
 * @since 3.0.0
 */
function alphaomegadigital_genesis_post_type_support() {
...
add_filter( 'wp_nav_menu_args', 'alphaomegadigital_genesis_secondary_menu_args' );
/**
 ...
 */
function alphaomegadigital_genesis_secondary_menu_args( $args ) {
...
add_filter( 'genesis_author_box_gravatar_size', 'alphaomegadigital_genesis_author_box_gravatar' );
/**
 ...
 */
function alphaomegadigital_genesis_author_box_gravatar( $size ) {

	return 90;

}

add_filter( 'genesis_comment_list_args', 'alphaomegadigital_genesis_comments_gravatar' );
/**
 ...
 */
function alphaomegadigital_genesis_comments_gravatar( $args ) {
