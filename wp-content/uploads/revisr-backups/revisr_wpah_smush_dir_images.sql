...
DROP TABLE IF EXISTS `wpah_smush_dir_images`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wpah_smush_dir_images` (
...
LOCK TABLES `wpah_smush_dir_images` WRITE;
/*!40000 ALTER TABLE `wpah_smush_dir_images` DISABLE KEYS */;
/*!40000 ALTER TABLE `wpah_smush_dir_images` ENABLE KEYS */;
UNLOCK TABLES;
