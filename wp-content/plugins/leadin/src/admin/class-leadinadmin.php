...
class LeadinAdmin {
	...
	public function build_menu() {
		...
		if ( ! empty( $portal_id ) ) {
			...
			add_submenu_page( MenuConstants::ROOT, __( 'Live Chat', 'leadin' ), __( 'Live Chat', 'leadin' ), 'edit_posts', MenuConstants::CHATFLOWS, array( $this, 'build_app' ) );
			add_submenu_page( MenuConstants::ROOT, __( 'Email', 'leadin' ), __( 'Email', 'leadin' ), 'edit_posts', MenuConstants::EMAIL, array( $this, 'build_app' ) );
			...
			add_submenu_page( MenuConstants::ROOT, __( 'Upgrade', 'leadin' ), __( 'Upgrade', 'leadin' ), 'edit_posts', MenuConstants::PRICING, array( $this, 'build_app' ) );
