...
<div class="wpb_fp_row">
	<div class="wpb_fp_quick_view_img <?php echo ( $images ? 'wpb_fp_has_gallery' : 'wpb_fp_no_gallery' );?> <?php echo ( $gallery_feature_image == 'on' ? 'wpb_fp_gallery_has_feature_image' : 'wpb_fp_gallery_disable_feature_image' );?> <?php echo apply_filters( 'wpb_fp_quick_view_img_column', 'col-md-6' )?> col-sm-12">
		<?php echo $quickview_content; ?>
		<?php echo ( $caption && $gallery_caption == 'on' ? '<div class="wpb_fp_caption"><p>'.$caption.'</p></div>' : '' ); ?>
	</div>
	<div class="wpb_fp_quick_view_content <?php echo apply_filters( 'wpb_fp_quick_view_content_column', 'col-md-6' )?> col-sm-12">
		...
		<?php
			...
			$content = apply_filters( 'wpb_fp_portfolio_content', $content );
