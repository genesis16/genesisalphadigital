...
function instant_ide_manager_update() {
	...
	// Update to Instant IDE Manager 1.1.8
	if ( version_compare( get_option( 'instant_ide_manager_version_number' ), '1.1.8', '<' ) )
		update_option( 'instant_ide_manager_version_number', '1.1.8' );
		
	// Update to Instant IDE Manager 1.2.0
	if ( version_compare( get_option( 'instant_ide_manager_version_number' ), '1.2.0', '<' ) )
		update_option( 'instant_ide_manager_version_number', '1.2.0' );
		
	// Update to Instant IDE Manager 1.2.1
	if ( version_compare( get_option( 'instant_ide_manager_version_number' ), '1.2.1', '<' ) )
		update_option( 'instant_ide_manager_version_number', '1.2.1' );
		
	// Update to Instant IDE Manager 1.2.2
	if ( version_compare( get_option( 'instant_ide_manager_version_number' ), '1.2.2', '<' ) )
		update_option( 'instant_ide_manager_version_number', '1.2.2' );
		
	// Update to Instant IDE Manager 1.3.0
	if ( version_compare( get_option( 'instant_ide_manager_version_number' ), '1.3.0', '<' ) )
		update_option( 'instant_ide_manager_version_number', '1.3.0' );

	// Update to Instant IDE Manager 1.5.0
	if ( version_compare( get_option( 'instant_ide_manager_version_number' ), '1.5.0', '<' ) )
		update_option( 'instant_ide_manager_version_number', '1.5.0' );

	// Update to Instant IDE Manager 1.6.0
	if ( version_compare( get_option( 'instant_ide_manager_version_number' ), '1.6.0', '<' ) )
		update_option( 'instant_ide_manager_version_number', '1.6.0' );

	// Update to Instant IDE Manager 1.6.1
	if ( version_compare( get_option( 'instant_ide_manager_version_number' ), '1.6.1', '<' ) )
		update_option( 'instant_ide_manager_version_number', '1.6.1' );

	// Update to Instant IDE Manager 1.7.0
	if ( version_compare( get_option( 'instant_ide_manager_version_number' ), '1.7.0', '<' ) )
		update_option( 'instant_ide_manager_version_number', '1.7.0' );
