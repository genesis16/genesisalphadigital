...
include_once plugin_dir_path(__FILE__) . 'register_blocks/index.php';
...
class edpl_ExtensionsManager
{
    ...
    public function __construct()
    {
        $this->extensions = [
            ...
            'register_blocks' => [
                'title' => 'Blocks',
                'description' => 'This extension enables you to copy blocks from GutenbergHub and add & allows you to create your own custom blocks.',
            ],
            'icon_inserter' => [
                'title'       => 'Icons Library',
