...
-->			
			  	...
			  	<div id="tabs-1">
						...
						-->
							...
							<?php 
					  			$available_items = array(
					  				...
					  				"post_excerpt" 			=> array( "type" => "variable", 	"name" => "Post Excerpt", 					"output" => "{{post_excerpt}}" ),
					  				...
					  				"categories" 			=> array( "type" => "variable", 	"name" => "Categories (comma separated)", 	"output" => "{{post_categories}}" ),
					  			);

					  			$html_items = array(
					  				"icon" 					=> array( "type" => "icon", 		"name" => "Icon", 							"output" => "fa-search" ),
					  				"text" 					=> array( "type" => "text", 		"name" => "Text", 							"output" => "Some Text" ),
					  				"acf_field" 			=> array( "type" => "acf_field", 	"name" => "ACF Field or WP Custom Field", 	"output" => "Field Name (single word, no spaces)" ),
					  			);
					  		?>
									...
									<?php foreach ($html_items as $key => $row) { ?>
										<div class="skin_item">
											...
											<div class="skin_item_controls">
												...
												<?php } ?>
												<?php if($row['type'] == 'acf_field'){ ?>
													<span title="Edit Field Name" class="button-primary mini fa fa-pencil edit_acf_field_item"></span>
												<?php } ?>
												<span title="Edit Action" class="button-primary mini fa fa-link edit_action_skin_item"></span>
												<span title="Delete Element" class="button-primary red mini fa fa-trash-o"></span>
											</div> 
					...
					<div class="acf_field_item">
						
						<input class="acf_field" type="text" style="width: 100%; display: block;"></input>
							
						<br>
							
						<div class="form-controls">
							<button class="button-primary save_acf_field_item"><span class="fa fa-check"></span> &nbsp;OK</button>
						</div>
